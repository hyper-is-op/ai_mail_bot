  ...
  const handleSaveGetPayload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.createConnectorConfig({
        ...
        request_template: JSON.stringify(parsedPayload),
        response_mapping: JSON.stringify({
          fields: [
            { field: 'docket_no', path: 'docket_no', extract_regex: null },
            { field: 'ticket_status', path: 'ticket_status', extract_regex: null }
          ]
        }),
  ...
  const handleSaveCreatePayload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.createConnectorConfig({
        ...
        response_mapping: JSON.stringify({
          fields: [
            { field: 'ticket_id', path: 'Refrence_No', extract_regex: null }
          ]
        }),
        status: 'pending_approval'
      });
        ...
        {showEmailModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 dark:bg-black/70 backdrop-blur-md p-4">
            <motion.div
              ...
              className="relative w-full max-w-xl overflow-hidden rounded-3xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-950/90 p-8 shadow-2xl backdrop-blur-xl"
            >
              ...
              <div className="flex items-center gap-3 mb-6 pb-4 border-b border-zinc-200 dark:border-white/5">
                ...
                <div>
                  <h2 className="text-xl font-bold tracking-tight text-zinc-900 dark:text-white">Step 1: Email Configuration (IMAP)</h2>
                  <p className="text-xs text-muted-foreground">Setup Gmail IMAP credentials to read incoming emails</p>
                </div>
              </div>

              {error && (
                <div className="mb-6 p-4 rounded-xl border border-rose-500/20 bg-rose-500/10 text-rose-600 dark:text-rose-400 text-sm font-medium">
                  {error}
                </div>
              )}

              <div className="bg-primary/5 border border-primary/20 rounded-xl p-4 text-sm text-zinc-700 dark:text-primary/90 leading-relaxed mb-6">
                <strong className="text-zinc-900 dark:text-white block mb-1">Why do we need this?</strong>
              ...
              <form onSubmit={handleSaveEmail} className="space-y-4">
                <div className="space-y-1">
                  <label className="text-sm font-medium text-zinc-700 dark:text-zinc-300">Gmail Address</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 text-zinc-900 dark:text-white"
                    />
                  </div>
                </div>

                <div className="space-y-1">
                  <label className="text-sm font-medium text-zinc-700 dark:text-zinc-300">App Password / Token</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-xl pl-10 pr-10 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 text-zinc-900 dark:text-white font-mono"
                    />
                    <button
                      type="button"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full mt-6 bg-primary text-primary-foreground py-3 rounded-xl font-medium shadow-lg shadow-primary/25 hover:bg-primary/95 transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 dark:bg-black/70 backdrop-blur-md p-4">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6 pb-4 border-b border-zinc-200 dark:border-white/5">
                ...
                <div>
                  <h2 className="text-xl font-bold tracking-tight text-zinc-900 dark:text-white">Step 2: Tracking Webhook (Get Ticket)</h2>
                  <p className="text-xs text-muted-foreground">Setup endpoints to fetch real-time ticket or order status</p>
                </div>
              </div>

              {error && (
                <div className="mb-6 p-4 rounded-xl border border-rose-500/20 bg-rose-500/10 text-rose-500 dark:text-rose-400 text-sm font-medium">
                  {error}
                </div>
              )}

              <div className="bg-emerald-500/5 border border-emerald-500/10 rounded-xl p-4 text-sm text-emerald-600 dark:text-emerald-400 leading-relaxed mb-6">
                <strong className="text-zinc-900 dark:text-white block mb-1">Why do we need this?</strong>
              ...
              <form onSubmit={handleSaveGetPayload} className="space-y-4">
                <div className="space-y-1">
                  <label className="text-sm font-medium text-zinc-600 dark:text-zinc-300">Tracking Webhook URL</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 text-zinc-900 dark:text-white font-mono"
                    />
                  </div>
                </div>

                <div className="space-y-1">
                  <label className="text-sm font-medium text-zinc-600 dark:text-zinc-300">Get Ticket JSON Template</label>
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      className="w-full bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 text-zinc-900 dark:text-white font-mono resize-none"
                    />
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full mt-6 bg-emerald-600 hover:bg-emerald-700 text-white py-3 rounded-xl font-semibold shadow-lg shadow-emerald-500/25 transition-all flex items-center justify-center gap-2"
                >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 dark:bg-black/70 backdrop-blur-md p-4">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6 pb-4 border-b border-zinc-200 dark:border-white/5">
                ...
                <div>
                  <h2 className="text-xl font-bold tracking-tight text-zinc-900 dark:text-white">Step 3: Webhook Endpoint (Create Ticket)</h2>
              ...
              <div className="bg-indigo-500/5 border border-indigo-500/10 rounded-xl p-4 text-sm text-indigo-600 dark:text-indigo-400 leading-relaxed mb-6">
                <strong className="text-zinc-900 dark:text-white block mb-1">Why do we need this?</strong>
              ...
              <form onSubmit={handleSaveCreatePayload} className="space-y-4">
                <div className="space-y-1">
                  <label className="text-sm font-medium text-zinc-600 dark:text-zinc-300">Create Webhook URL</label>
                  <div className="relative">
                    <Database className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                    <input
                      type="url"
                      ...
                      className="w-full bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 text-zinc-900 dark:text-white font-mono"
                    />
                  </div>
                </div>

                <div className="space-y-1">
                  <label className="text-sm font-medium text-zinc-600 dark:text-zinc-300">Create Ticket JSON Template</label>
                  <div className="relative">
                    <Code2 className="absolute right-3 top-3 h-4 w-4 text-muted-foreground" />
                    <textarea
                      required
                      ...
                      className="w-full bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 text-zinc-900 dark:text-white font-mono resize-none"
                    />
                  </div>
                </div>
